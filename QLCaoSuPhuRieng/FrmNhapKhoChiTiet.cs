    ...
    public partial class FrmNhapKhoChiTiet : RibbonForm
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            try {
                ...
                if (them)
                {
                    ...
                    if (null!=cbGhiChu.SelectedValue)
                        nhapkhochitiet.Ghichu = cbGhiChu.SelectedValue.ToString();
                    //
                    dr = dt.NewRow();
                    dr["ID"] = nhapkho.ID;
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (traloi == DialogResult.Yes)
                {
                    ...
                    if (nl.XoaNhapKhoChiTiet(ref err, nhapkhochitiet))
                    {
        ...
        */
        ...
        private void creatReportKS(string sql, string nguon)
        {
            ...
            rpt.DataSource = null;
            rpt.xrlblNhaMay.Text = "NMCB " + NHAMAY + " - Dây chuyền Mủ TINH";
